...
class Leetcode:
    ...
    def login(self):
        ...
        if 'LEETCODE_SESSION' not in [
            ...
            raise Exception('Please check your username & password or your network.')
...
|:---:|:---:|:---:|:---:|:---:|'''.format(
    ...
    def push_to_github(self):
        ...
        if repo_name not in os.popen('git remote -v').read():
            git_add_remote = 'git remote add origin {repo}'.format(repo = CONFIG['repo'])
